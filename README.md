...
| [Four-Digit Hexadecimal Seven-Segment Display](./Four_Digit_Hexadecimal_ Seven_Segment_Display/) | Multiplexed four-digit active-low seven-segment display controller with hexadecimal decoder, scan counter, digit selection, reset logic, and self-checking simulation |
